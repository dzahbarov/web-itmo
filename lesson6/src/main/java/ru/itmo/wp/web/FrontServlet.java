...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method = null;
        for (Class<?> clazz = pageClass; (method == null || afterMethod == null || beforeMethod == null) && clazz != null; clazz = clazz.getSuperclass()) {
            try {
                if (method == null) {
        ...
        if (method == null || afterMethod == null || beforeMethod == null) {
            throw new NotFoundException();
        }
        ...
        if (invokeMethod(request, response, pageClass, method, page, view)) {
            return;
        }
