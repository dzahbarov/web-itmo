...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route, HttpServletRequest request, HttpServletResponse response)
        ...
        if (parameterMap.containsKey("lang") && parameterMap.get("lang").length == 1) {
            String lang = parameterMap.get("lang")[0];
        ...
        String nameWithLang = pageClass.getSimpleName() + (lang.equals("en") ? "" : ("_" + lang)) + ".ftlh";
        String name = pageClass.getSimpleName() + ".ftlh";
