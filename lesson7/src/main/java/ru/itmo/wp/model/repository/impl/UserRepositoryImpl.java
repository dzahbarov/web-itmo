...
public class UserRepositoryImpl implements UserRepository {
    ...
    public void save(User user, String passwordSha) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement("INSERT INTO `User` (`login`, `passwordSha`, `email`, `creationTime`, `admin`) VALUES (?, ?, ?, NOW(), 0)", Statement.RETURN_GENERATED_KEYS)) {
